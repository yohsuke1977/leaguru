---
title: 得失点差とは？計算式「総得点－総失点」と同率順位の決め方
description: 得失点差は「シーズン総得点－シーズン総失点」で計算するシンプルな指標です。3チームの順位表を使った具体例、草野球リーグで同率チームの順位を決める際の使用順序、不戦勝・コールドゲームが絡む場合の注意点まで、規約に落とし込むポイントをまとめました。
date: 2026-09-07
...
この並びだけを見ると「Aチームが一番強い」ように見えますが、注意が必要なのは**直接対決の結果を先に確認したか**です。仮にAチームがBチーム・Cチームとの直接対決で両方負けていた場合、得失点差だけで1位にしてしまうと「負けているのに1位」という納得感の薄い結果になります。前述の「勝率→直接対決→得失点差」の順序を飛ばさないことが、この具体例からも分かります。
