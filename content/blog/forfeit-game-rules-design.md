---
title: 草野球の「没収試合」とは？試合成立に必要な人数と、遅刻・棄権のルール設計
description: 「没収試合」とは何を指す？コールドゲームとの違いを整理したうえで、草野球で試合が成立する人数ライン（8人・9人）、没収試合の発動条件とスコアの扱い、遅刻・棄権への段階的ペナルティ設計まで、規約に落とし込む実務ポイントをまとめました。
date: 2026-07-21
...
まず言葉の整理から。この2つは「試合が最後まで行われない」という点で混同されがちですが、**発生する理由**が違います。

| 用語 | 発生する理由 | 記録 |
|---|---|---|
| **没収試合（フォーフィット）** | 人数不足・無断欠場・不正出場など、**試合を行える状態にならなかった**ことが原因 | 一方の不戦敗として処理する |
| **コールドゲーム** | 大差・降雨・日没など、**試合は成立しているが途中で打ち切る**ことが原因 | 打ち切り時点のスコアをそのまま採用する |

没収試合は「試合そのものが成立しなかった」扱い、コールドゲームは「試合は成立したが規定回数に達する前に終わった」扱いという違いがあります。雨天によるコールドゲームの判断基準や得点処理は[雨天中止・順延の判断基準と連絡フロー](/blog/rain-cancellation-decision-flow)で詳しく解説しているので、この記事では人数不足・欠場に起因する没収試合に絞って整理します。
...
### Q. 没収試合とコールドゲームは同じ意味ですか？

いいえ、原因が異なります。没収試合は人数不足や無断欠場など「試合を行える状態にならなかった」場合に一方の不戦敗として処理するもので、試合そのものが成立しません。一方コールドゲームは、試合は成立した上で大差や降雨・日没などにより規定回数を待たずに打ち切るもので、打ち切り時点のスコアがそのまま採用されます。規約を作る際は、この2つを別条文として分けて定義しておくと、当日の判断がぶれにくくなります。
