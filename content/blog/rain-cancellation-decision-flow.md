---
title: 野球の「順延」とは？雨天中止との違いと、草野球の判断基準・連絡フロー
description: 「順延」とは試合を後日に延期すること。中止（その試合を取りやめる）との違いをまず整理したうえで、草野球リーグでの雨天中止・順延の判断基準、決定権者とタイムライン、連絡フロー、予備日の設計までを現場の実感ベースで解説します。
date: 2026-07-14
...
まず言葉の整理から。この2つは似ていますが、**その後どうなるか**が違います。

| 用語 | 意味 | その後 |
|---|---|---|
| **順延** | 予定していた試合を**後日に延期**すること | 予備日などで改めて開催する |
| **中止** | その試合を**取りやめる**こと | 開催しない（成立扱い・引き分け扱いなどは規約による） |

「雨天順延」は雨で試合を後日に延ばすこと、「雨天中止」は雨でその試合をやらないことです。
順延を前提にするなら**予備日をあらかじめ確保**しておく必要があり、そこまで含めて設計しないと
「順延と言ったのに、いつやるか決まらない」という宙ぶらりんの状態になります。

なお野球では、試合成立前に降雨で打ち切られた場合を「ノーゲーム」と呼びます。
草野球では何回で成立とするかをリーグ規約で定めるのが一般的です（5回・7回制など）。
