---
title: ノーゲームとコールドゲームの違いは？草野球は「5回」が試合成立の目安
description: ノーゲームとコールドゲームの違いは「試合が成立したか」の一点。草野球リーグでは5回終了を目安にするケースが多数派です。何回から試合成立とするか、後攻有利時の半端イニングの具体例、規約の書き方までまとめました。
date: 2026-09-02
...
**具体例：5回表終了時点で後攻が逆転していたケース**

言葉だけだとイメージしづらいので、スコアの推移で確認します（数値は説明用の一例です）。

| 時点 | 先攻 | 後攻 | この時点の勝敗 |
|---|---|---|---|
| 4回終了 | 3 | 1 | 先攻が2点リード |
| 5回表終了（雨天中断） | 3 | 4 | 後攻が1点リード |

5回表の攻撃で後攻が3点を返し、5回表終了時点では「3-4」で後攻がリードしています。しかしこの時点で後攻はまだ5回裏を攻撃していないため、上記の規約に従うと最終スコアは4回終了時点の「3-1」（先攻リード）に戻ります。選手からすると「土壇場で追いついたのに、なぜ負け扱いなのか」と感じやすい場面なので、この処理を規約に明記したうえで、試合前のミーティングや掲示物でも周知しておくと、雨天中断後のトラブルを防げます。
